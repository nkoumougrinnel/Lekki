...
class WikiPage(Base):
    ...
    status = Column(String, default="draft")  # draft, community, verified
    ...
    related_document_ids = Column(Text, default="[]")  # JSON string of doc IDs
    related_wiki_ids = Column(Text, default="[]")      # JSON string of wiki IDs
